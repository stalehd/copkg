...
/**
 * Test utilities for networking.
 *
 * TODO(borud): this class was copied from Cloudname testtools. We
 *   should either move this package into the Cloudname repos and use
 *   testtols from there or we should get this into Maven central so
 *   it can build properly for people who do not have testtols in
 *   their maven repos.
 *
 * @author borud
 */
